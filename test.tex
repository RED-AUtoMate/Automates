...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item
        \begin{center}
            \includegraphics [width=8cm, height=4cm,center]{automateDeterministe.png}
        \end{center}

        \item
        \begin{center}
            \includegraphics [width=8cm, height=4cm,center]{automateMinimal.png}
        \end{center}

        \item
        \begin{center}
            \includegraphics [width=8cm, height=4cm,center]{automateSynchro.png}
        \end{center}
